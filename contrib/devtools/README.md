...
Provides utilities for managing copyright headers of `The pacprotocol
...
pacprotocol/pacprotocold repository.
...
Setup
---------
Configuring the github-merge tool for the pacprotocol repository is done in the following way:

    git config githubmerge.repository pacprotocol/pacprotocol
...
A script to optimize png files in the pacprotocol
