...
public:
    ...
    {
        READWRITE(obj.header, obj.nonce, obj.vchBlockSig, obj.netProof, Using<VectorFormatter<CustomUintFormatter<SHORTTXIDS_LENGTH>>>(obj.shorttxids), obj.prefilledtxn);
