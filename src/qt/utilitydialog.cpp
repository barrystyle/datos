    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  pacprotocol-qt [command-line options]                     \n";
...
All the pacprotocol in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.pacprotocol.org/en/stable/wallets/pacprotocolcore/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
