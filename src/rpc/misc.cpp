    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"debug",
                ...
                " - \"pacprotocol\" activates all pacprotocol-specific categories at once;\n"
            ...
            "  result               (string) \"Debug mode: \" followed by the specified category.\n"
                ...
                RPCExamples {
                    HelpExampleCli("debug", "pacprotocol")
            + HelpExampleRpc("debug", "pacprotocol+net")
            }}.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given pacprotocol address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The pacprotocol address to validate"},
                },
                RPCResult{
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The pacprotocol address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "pacprotocol-cli and the GUI. There is no server-side difference.",
                {},
