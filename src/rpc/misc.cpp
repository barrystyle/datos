    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"debug",
                ...
                " - \"datos\" activates all datos-specific categories at once;\n"
            ...
            "  result               (string) \"Debug mode: \" followed by the specified category.\n"
                ...
                RPCExamples {
                    HelpExampleCli("debug", "datos")
            + HelpExampleRpc("debug", "datos+net")
            }}.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given Datos address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Datos address to validate"},
                },
                RPCResult{
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The Datos address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "datos-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* datos features */
    { "datos",               "mnsync",                 &mnsync,                 {} },
    { "datos",               "spork",                  &spork,                  {"arg0","value"} },
    { "datos",               "setstaking",             &setstaking,             {"mode"} },
