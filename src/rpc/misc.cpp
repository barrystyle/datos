    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"debug",
                ...
                " - \"datosdrive\" activates all datosdrive-specific categories at once;\n"
            ...
            "  result               (string) \"Debug mode: \" followed by the specified category.\n"
                ...
                RPCExamples {
                    HelpExampleCli("debug", "datosdrive")
            + HelpExampleRpc("debug", "datosdrive+net")
            }}.ToString());
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given datosdrive address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The datosdrive address to validate"},
                },
                RPCResult{
            "{\n"
    ...
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The datosdrive address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "datosdrive-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* datosdrive features */
    { "datosdrive",               "mnsync",                 &mnsync,                 {} },
    { "datosdrive",               "spork",                  &spork,                  {"arg0","value"} },
    { "datosdrive",               "setstaking",             &setstaking,             {"mode"} },
